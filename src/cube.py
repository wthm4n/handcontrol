...
COLOR_IDLE     = (180, 200,  50)
COLOR_HOVER    = (220, 240,  20)
COLOR_GRAB     = ( 50, 255, 120)
COLOR_FLYING   = (255,  80, 180)
COLOR_SELECTED = ( 30, 190, 255)
COLOR_DELETE   = ( 40,  40, 240)
...
class Cube:
    ...
    def _draw_shadow_direct(self, img, screen_cx, screen_cy, frame_h):
        ...
        darkness = int(30 * (1.0 - height_frac))
        if darkness < 2:
            return
